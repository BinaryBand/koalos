...
/**
 * Retrieves a FA (FA1.2 or FA2) contract instance at the specified Tezos address.
 *
 * @template T - The type of the FA contract, extending the base FA type.
 * @param address - The address of the FA contract on the Tezos blockchain.
 * @returns A promise that resolves to the contract instance of type T.
 */
export async function getFaContract<T extends FA = FA>(address: string): Promise<T> {
